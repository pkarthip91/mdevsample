  ...
  return (
    <Box >
      ...
      >
        ...
        {/* Add your content */}
        <Typography className="animate__animated animate__fadeInLeft banner-heading" variant="h1" component="h2"
          sx={{
        ...
        >
          Welcome to the <span className="banner-text-grd animate__animated animate__swing animate__infinite-3 banner-res-text"> Developer’s</span> Playground
        </Typography>
        {/* Add your content */}
